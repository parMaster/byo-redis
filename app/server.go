...
func (s *Server) handleConnection(connection net.Conn, silent bool) error {
	...
	for {
		// Read the input
		typeResponse, args, err := s.readInput(connection, reader)
...
func (s *Server) readInput(connection net.Conn, reader *bufio.Reader) (typeResponse rune, args []string, err error) {
